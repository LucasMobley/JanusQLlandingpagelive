    ...
    return (
      <Layout>
        ...
        <div id="main">
          ...
          <div>
          <section id="cta" className="main special">
            <header id="email" className="major" >
              <h2> Sign up for our mailing list!</h2>
              <p>
               JanusQL is new and fresh!  Let's stay in touch so we can keep you updated with new features.
              </p>
            </header>
            <footer className="major">
              <ul className="actions">
                <li>
                  <Link target="_blank" to="http://eepurl.com/ht8cMD" className="button special">
                    Subscribe
                  </Link>
                </li>
              </ul>
